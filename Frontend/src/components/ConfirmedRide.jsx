...
const vehicleImages = {
    ...
    motorcycle: "https://cn-geo1.uber.com/image-proc/crop/resizecrop/udam/format=auto/width=552/height=552/srcb64=aHR0cHM6Ly90Yi1zdGF0aWMudWJlci5jb20vcHJvZC91ZGFtLWFzc2V0cy85NTM4NTEyZC1mZGUxLTRmNzMtYmQ1MS05Y2VmZjRlMjU0ZjEucG5n",
...
return (
    ...
    <div className="flex gap-2 flex-col justify-between items-center">
        ...
        className="w-full mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg disabled:opacity-70"
        >
